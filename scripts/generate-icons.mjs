 ...
 * Coherente con el tema: degradado azul (#3b82f6 → #1d4ed8) + glifo de foto/álbum.
 *
...
<svg width="512" height="512" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
  ...
  <circle cx="120" cy="110" r="240" fill="#ffffff" opacity="0.07"/>
  ...
  <g transform="translate(256 256) scale(${glyphScale}) translate(-256 -256)">
    ...
    <g transform="rotate(-9 256 266)">
      <rect x="151" y="181" width="210" height="170" rx="22" fill="#ffffff" opacity="0.4"/>
    </g>
    <!-- foto frontal -->
    <rect x="151" y="181" width="210" height="170" rx="22" fill="url(#frame)"/>
    <g clip-path="url(#photoclip)">
      <circle cx="205" cy="228" r="20" fill="#fbbf24"/>
      <path d="M151 351 L211 286 L255 322 L312 258 L361 312 L361 351 Z" fill="#1d4ed8"/>
      <path d="M151 351 L243 300 L300 334 L361 296 L361 351 Z" fill="#3b82f6"/>
    </g>
  </g>
</svg>`;
